...
CREATE FUNCTION hdb_views.user__insert__public__project_writer() RETURNS trigger
  ...
  BEGIN
    conflict_clause = current_setting('hasura.conflict_clause')::jsonb;
    IF ((EXISTS  (SELECT  1  FROM "public"."project" AS "_be_0_public_project" WHERE (((("_be_0_public_project"."id") = (NEW."project_id")) AND ('true')) AND ((EXISTS  (SELECT  1  FROM "public"."project_administrator" AS "_be_1_public_project_administrator" WHERE (((("_be_1_public_project_administrator"."project_id") = ("_be_0_public_project"."id")) AND ('true')) AND ((((("_be_1_public_project_administrator"."administrator_id") = (((current_setting('hasura.user')::json->>'x-hasura-user-id'))::integer)) OR ((("_be_1_public_project_administrator"."administrator_id") IS NULL) AND ((((current_setting('hasura.user')::json->>'x-hasura-user-id'))::integer) IS NULL))) AND ('true')) AND ('true')))     )) AND ('true')))     )) AND ('true')) THEN
      CASE
...
public	project_writer	user	insert	{"set": {}, "check": {"project": {"project_administrators": {"administrator_id": {"_eq": "X-Hasura-User-Id"}}}}, "columns": ["project_id", "unique_writer", "writer_id"]}	\N	f
...
public	user	user	select	{"filter": {}, "columns": ["email", "id", "username"], "computed_fields": [], "allow_aggregations": false}	\N	f
\.
...
514d5967-1186-4f3a-bebc-cf952dc26ac9	2020-01-07 13:43:22.07666+00
\.
...
3	4	<p>A modifi&eacute; les dispositions suivantes : - Code de la sant&eacute; publique Art. R1111-15-1A modifi&eacute; les dispositions suivantes : - Code de la sant&eacute; publique Sct. Sous-section 2 : H&eacute;bergement des donn&eacute;es de sant&eacute; &agrave; caract&egrave;re personnel sur support informatiqueA modifi&eacute; les dispositions suivantes : - Code de la sant&eacute; publique Art. R1111-9, Art. R*1111-10, Art. R1111-15, Art. R1111-16</p>\n\n<p><ins class="ice-ins ice-cts-1" data-changedata="" data-cid="2" data-last-change-time="1577973003482" data-time="1577973003201" data-userid="1" data-username="Hugo">KZ?KE</ins></p>\n	\N	Hugo - jeudi 2 janvier 2020 à 14:50:03
4	4	<p>A modifi&eacute; les dispositions suivantes : - Code de la sant&eacute; publique Art. R1111-15-1A modifi&eacute; les dispositions suivantes : - Code de la sant&eacute; publique Sct. Sous-section 2 : H&eacute;bergement des donn&eacute;es de sant&eacute; &agrave; caract&egrave;re personnel sur support informatiqueA modifi&eacute; les dispositions suivantes : - Code de la sant&eacute; publique Art. R1111-9, Art. R*1111-10, Art. R1111-15, Art. R1111-16</p>\n\n<p><ins class="ice-cts-1 ice-ins" data-changedata="" data-cid="2" data-last-change-time="1577973012099" data-time="1577973003201" data-userid="1" data-username="Hugo">KZ?KE</ins></p>\n\n<p>&nbsp;</p>\n\n<p><ins class="ice-cts-1 ice-ins" data-changedata="" data-cid="2" data-last-change-time="1577973012099" data-time="1577973003201" data-userid="1" data-username="Hugo">EEEE﻿</ins></p>\n	\N	Hugo - jeudi 2 janvier 2020 à 14:50:12
\.
...
6	nameInserted	Test de description	2019-12-23	11
7	Test de nouveau projet	Ceci est une descrupotion d'un new	2019-12-23	11
8	Projet de michelle	Michelle descritpion	2019-12-23	17
9	From scratch	Ce projet est from scratch	2020-01-06	11
11	Projet 1	ceci est le premier Projet	2020-01-07	11
\.
...
COPY public."user" (id, username, email, password, active, create_at) FROM stdin;
11	Hugo	hugo.feldstein@celaneo.com	$2a$10$IlusAL1u.ZWvGfOLptd7Z.9KNcvJ9AiW4XB6zN.xw7mhD4FPl44Yu	t	2019-12-17 14:01:47.159525+00
16	HugoTest	test2@hugo.com	$2a$10$GDGkuXLWO3f/Cf7e3GQM2e9lHzoQxBXfvHQTddkneFH29nOYrrbPm	t	2019-12-23 13:55:07.754046+00
17	Michelle	michelle@bonjour.com	$2a$10$9W.GFVkmo2NHR8Cxd467SOgmIAlaDSzB7IZP2TdQVdqbFNz00A9MW	t	2019-12-23 18:52:51.651532+00
\.
...
SELECT pg_catalog.setval('public.article_revision_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.project_administrator_id_seq', 71, true);
...
SELECT pg_catalog.setval('public.project_writer_id_seq', 59, true);
